...
For i = 2 To last2
'use the worksheet function max to look at the entire column and select the given row if it is the max value, and then print the corresponding value from the percent change column, formatting it as a percentage of course
